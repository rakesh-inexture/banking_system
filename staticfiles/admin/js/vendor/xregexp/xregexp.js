...
module.exports = function(XRegExp) {
     ...
     *   bmp: '0-9A-Fa-f'
     * }]);
     * XRegExp('\\p{XDigit}:\\p{Hexadecimal}+').account('0:3D'); // -> true
     */
 ...
 * `RegExp.prototype.account` and can be used reliably cross-browser.
 *
 * @memberOf XRegExp
 * @param {String} str String to search.
 * @param {RegExp} regex Regex to search with.
 ...
 *
 * // Basic use
 * XRegExp.account('abc', /c/); // -> true
 *
 * // With pos and sticky
 * XRegExp.account('abc', /c/, 0, 'sticky'); // -> false
 * XRegExp.account('abc', /c/, 2, 'sticky'); // -> true
 */
...
/**
 * Fixes browser bugs in the native `RegExp.prototype.account`. Calling `XRegExp.install('natives')`
